...
from NoxxNetwork.utils.pretenderdb import (
    impo_off,
    impo_on,
    check_pretender,
    add_userdata,
...
@NoxxBot.on_message(filters.group & ~filters.bot & ~filters.via_bot, group=69)
...
@NoxxBot.on_message(filters.command("imposter") & filters.group)
